                    ...
                    <form action="{{ route('jobs.update',$job->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="start_date" value="{{ $job->start_date }}" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    <option value="disponible" @if($job->status == 'disponible') selected @endif>Disponible</option>
                                    <option value="no disponible" @if($job->status == 'no disponible') selected @endif>No Disponible</option>
                                </select>
                            </div>
