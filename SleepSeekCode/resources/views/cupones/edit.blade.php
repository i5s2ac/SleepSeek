                    ...
                    <form action="{{ route('cupones.update', $cupon->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                            <div class="space-y-2">
                                ...
                                <input class="w-full p-2 border rounded focus:border-blue-500 focus:outline-none" name="codigo" type="text" placeholder="Code" value="{{ $cupon->codigo }}">
                            </div>

                            <div class="space-y-2">
                                <label class="block text-gray-700 font-medium" for="descuento">Discount:</label>
                                <input class="w-full p-2 border rounded focus:border-blue-500 focus:outline-none" name="descuento" type="text" placeholder="Discount" value="{{ $cupon->descuento }}">
                            </div>

                            <div class="space-y-2">
                                <label class="block text-gray-700 font-medium" for="fecha_expiracion">Expiration Date:</label>
                                <input class="w-full p-2 border rounded focus:border-blue-500 focus:outline-none" name="fecha_expiracion" type="date" value="{{ $cupon->fecha_expiracion }}">
                            </div>
