    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Plazas Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('plazas')" :active="request()->routeIs('plazas')" :class="request()->routeIs('plazas') ? 'nav-link-active' : ''">
                        {{ __('Plazas') }}
                    </x-nav-link>
                ...
                <!-- Chats Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('chats')" :active="request()->routeIs('chats')" :class="request()->routeIs('chats') ? 'nav-link-active' : ''">
                        {{ __('Chats') }}
                    </x-nav-link>
                </div>
                ...
                <!-- Notifications Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('notificaciones')" :active="request()->routeIs('notificaciones')" :class="request()->routeIs('notificaciones') ? 'nav-link-active' : ''">
                        {{ __('Notificaciones') }}
                    </x-nav-link>
                </div>
            </div>
